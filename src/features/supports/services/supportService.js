...
function createTicket({ subject, message, category, orderId, priority }) {
  const req = apiClient.post();
  req.url  = resolvePath(API_PATH.support.create);
  req.body = { subject, message, category, orderId, priority };
  return req
...
export const supportService = {
  ...
  getAdminTickets, getAdminStats, updateTicketStatus, assignTicket,
};
